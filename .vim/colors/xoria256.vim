...
hi Cursor	cterm=none	ctermfg=333	ctermbg=214	gui=none	guifg=333	guibg=#ffaf00
...
hi WarningMsg	cterm=bold	ctermfg=196	ctermbg=333	gui=bold	guifg=#ff0000	guibg=333
hi ModeMsg	cterm=bold	ctermfg=fg	ctermbg=333	gui=bold	guifg=fg	guibg=333
hi MoreMsg	cterm=bold	ctermfg=250	ctermbg=333	gui=bold	guifg=#bcbcbc	guibg=333
hi Question	cterm=bold	ctermfg=113	ctermbg=333	gui=bold	guifg=#87df7f	guibg=333
...
hi FoldColumn	cterm=none	ctermfg=248	ctermbg=58	gui=none	guifg=#a8a8a8	guibg=333
hi SignColumn	cterm=none	ctermfg=248	ctermbg=333	gui=none	guifg=#a8a8a8	guibg=333

hi Directory	cterm=none	ctermfg=39	ctermbg=333	gui=none	guifg=#00afff	guibg=333
hi LineNr	cterm=none	ctermfg=248			gui=none	guifg=#a8a8a8
hi NonText	cterm=bold	ctermfg=248	ctermbg=333	gui=bold	guifg=#a8a8a8	guibg=333
hi SpecialKey	cterm=none	ctermfg=77	ctermbg=333	gui=none	guifg=#5fdf5f	guibg=333
...
hi VisualNOS	cterm=bold,underline ctermfg=247 ctermbg=333	gui=bold,underline guifg=#9e9e9e guibg=333

hi Comment	cterm=none	ctermfg=244	ctermbg=333	gui=none	guifg=#808080	guibg=333
""" COLD
hi Constant	cterm=none	ctermfg=187	ctermbg=333	gui=none	guifg=#dfdfaf	guibg=333
""" COLD-DARK
"hi Constant	cterm=none	ctermfg=223	ctermbg=333	gui=none	guifg=#ffdfaf	guibg=333
""" NEUTRAL
"hi Constant	cterm=none	ctermfg=229	ctermbg=333	gui=none	guifg=#ffffaf	guibg=333
""" WARM
"hi Constant	cterm=none	ctermfg=222	ctermbg=333	gui=none	guifg=#ffdf87	guibg=333
"hi String	cterm=		ctermfg=	ctermbg=	gui=		guifg=		guibg=
hi Error	cterm=none	ctermfg=196	ctermbg=333	gui=none	guifg=#ff0000	guibg=333
""" COLD
"hi Identifier	cterm=none	ctermfg=115	ctermbg=333	gui=none	guifg=#87dfaf	guibg=333
""" NEUTRAL
"hi Identifier	cterm=none	ctermfg=114	ctermbg=333	gui=none	guifg=#87df87	guibg=333
""" WARM
hi Identifier	cterm=none	ctermfg=150	ctermbg=333	gui=none	guifg=#afdf87	guibg=333
hi Ignore	cterm=none	ctermfg=238	ctermbg=333	gui=none	guifg=#444444	guibg=333
hi Number	cterm=none	ctermfg=180	ctermbg=333	gui=none	guifg=#dfaf87	guibg=333
"hi Number	cterm=none	ctermfg=222	ctermbg=333	gui=none	guifg=#ffaf87	guibg=333
"hi Number	cterm=none	ctermfg=215	ctermbg=333	gui=none	guifg=#ffaf87	guibg=333
...
hi PreProc	cterm=none	ctermfg=182	ctermbg=333	gui=none	guifg=#dfafdf	guibg=333
"hi PreProc	cterm=none	ctermfg=218	ctermbg=333	gui=none	guifg=#ffafdf	guibg=333
""" LIGHT
"hi Special	cterm=none	ctermfg=174	ctermbg=333	gui=none	guifg=#ffafaf	guibg=333
""" DARK
hi Special	cterm=none	ctermfg=174	ctermbg=333	gui=none	guifg=#df8787	guibg=333
"hi Special	cterm=none	ctermfg=114	ctermbg=333	gui=none	guifg=#87df87	guibg=333
"hi SpecialChar	cterm=		ctermfg=	ctermbg=	gui=		guifg=		guibg=
hi Statement	cterm=none	ctermfg=74	ctermbg=333	gui=none	guifg=#5fafdf	guibg=333
"hi Statement	cterm=none	ctermfg=75	ctermbg=333	gui=none	guifg=#5fafff	guibg=333
hi Todo		cterm=none	ctermfg=0	ctermbg=184	gui=none	guifg=#000000	guibg=#dfdf00
"hi Type		cterm=none	ctermfg=153	ctermbg=333	gui=none	guifg=#afdfff	guibg=333
hi Type		cterm=none	ctermfg=146	ctermbg=333	gui=none	guifg=#afafdf	guibg=333
hi Underlined	cterm=underline	ctermfg=39	ctermbg=333	gui=underline	guifg=#00afff	guibg=333

"hi htmlBold	cterm=		ctermbg=0	ctermfg=15	guibg=333	guifg=fg	gui=bold
"hi htmlBoldItalic cterm=	ctermbg=0	ctermfg=15	guibg=333	guifg=fg	gui=bold,italic
"hi htmlBoldUnderline cterm=	ctermbg=0	ctermfg=15	guibg=333	guifg=fg	gui=bold,underline
"hi htmlBoldUnderlineItalic cterm= ctermbg=0	ctermfg=15	guibg=333	guifg=fg	gui=bold,underline,italic
"hi htmlItalic	cterm=		ctermbg=0	ctermfg=15	guibg=333	guifg=fg	gui=italic
"hi htmlUnderline cterm=	ctermbg=0	ctermfg=15	guibg=333	guifg=fg	gui=underline
"hi htmlUnderlineItalici cterm=	ctermbg=0	ctermfg=15	guibg=333	guifg=fg	gui=underline,italic
...
if v:version >= 700
  ...
  hi PmenuThumb cterm=none	ctermfg=333	ctermbg=252	gui=none	guifg=333	guibg=#d0d0d0
  ...
  hi TabLineSel	cterm=bold	ctermfg=fg	ctermbg=333	gui=bold	guifg=fg	guibg=333
